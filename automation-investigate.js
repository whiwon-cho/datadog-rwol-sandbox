/**
 * Datadog RUM 자동화 테스트 스크립트 - Investigate 페이지 집중 테스트 (V2)
 * Investigate 페이지만 반복: Investigate 페이지 → 버튼 클릭 → Reset Session → 반복
 */
...
// 한 사이클 실행 - Investigate 페이지만 집중 테스트 (V2)
const runCycle = async (page, cycleNum) => {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`🔄 사이클 ${cycleNum} 시작 [Investigate 페이지 집중]`);
